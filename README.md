...
ollama ile mistral,llama3. v.d.   -  ollama run llama3 "$(cat subSDGprompt.txt)" -> tek seferde token problemi olunca yerelde aşağıdaki gibi tek tek işletildi.
...
yerelde ise llama3, mistral ve phi4 ollama modelleri Ollama (sürüm 0.11.10) ile; laguna-xs.2 modeli ise ise Ollama (sürüm 0.22.1) ile koşturuldu.
